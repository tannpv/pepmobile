		...
		<fieldset class="adminform">
			...
			<ul class="adminformlist">
				...
				<?php echo $this->form->getInput('alias'); ?></li>
                                ...
                                <?php if(!$this->catname && !$this->catid) : ?>
				<li><?php echo $this->form->getLabel('catid'); ?>
				<?php echo $this->form->getInput('catid'); ?></li>
                              <?php else : ?>
                                <li><label><?php echo JText::_('Category');?></label>
                                   <input type="text" readonly="readonly" size="10" class="readonly" value="<?php echo $this->catname; ?>" aria-invalid="false">
				</li>
