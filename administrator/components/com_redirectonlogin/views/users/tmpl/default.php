		...
		<table class="adminlist table table-striped" width="100%">
			<thead>
				<tr>				
					...
					<th class="nowrap">
						<?php 	
						$label = JText::_('COM_REDIRECTONLOGIN_REDIRECT_TYPE').$j3br.JText::_('COM_REDIRECTONLOGIN_BACKEND');				
			...
			foreach ($this->items as $i => $item) : ?>
				<tr class="row<?php echo ($i+1) % 2; ?>">				
					...
					<td class="center">
						<?php 					
						//echo nl2br($item->level_title);
						//echo $item->level_ids; 
						
						//$levels_ids_array = explode('-', $item->level_ids);
