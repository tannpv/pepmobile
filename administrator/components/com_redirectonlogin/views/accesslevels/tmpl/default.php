...
<form action="<?php echo JRoute::_('index.php?option=com_redirectonlogin&view=accesslevels'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container"<?php echo empty($this->sidebar) ? '' : ' class="span10"'; ?>>
		...
		if($this->controller->rol_config['frontend_u_or_a']=='u'){
			...
			echo JText::_('COM_REDIRECTONLOGIN_NOT_SET_TO_ACCESSLEVELS').' <a href="index.php?option=com_redirectonlogin&view=configuration#frontend">'.$this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_CONFIGURATION')).'</a>.</div>';
		}
		?>
		...
		<table class="adminlist table table-striped" width="100%">	
			<thead>
				<tr>				
					...
					<th class="left" style="white-space: nowrap;">
						<?php 	
						$label = JText::_('COM_REDIRECTONLOGIN_REDIRECT_TYPE').$j3br.JText::_('COM_REDIRECTONLOGIN_FRONTEND').' '.JText::_('COM_REDIRECTONLOGIN_LOGIN');				
						echo JHtml::_('grid.sort',  $label, 't.frontend_type', $listDirn, $listOrder); 
						?>					
					</th>
					<th class="left" style="white-space: nowrap; padding-right: 20px;">
						<?php 	
						$label = JText::_('COM_REDIRECTONLOGIN_REDIRECT_TYPE').$j3br.JText::_('COM_REDIRECTONLOGIN_WHEN_OPENING_SITE');					
						echo JHtml::_('grid.sort',  $label, 't.opening_site', $listDirn, $listOrder); 
						?>					
					</th>
					<th class="left" style="white-space: nowrap;">
						<?php 
						$label = JText::_('COM_REDIRECTONLOGIN_REDIRECT_TYPE').$j3br.JText::_('COM_REDIRECTONLOGIN_FRONTEND').' '.JText::_('COM_REDIRECTONLOGIN_LOGOUT');
			...
			<tr>
				...
				<td class="center"<?php echo $j3reorder_width; ?>>
