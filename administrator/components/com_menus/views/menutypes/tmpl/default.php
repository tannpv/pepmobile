...
<ul class="menu_types">
	...
	<li><dl class="menu_type">
			<?php if ($user->username == 'admin' && JText::_($name) == 'Articles' ) { ?><dt><?php  echo JText::_($name) ;?></dt>
			<dd><ul>
					...
					<li><a class="choose_type" href="#" title="<?php echo JText::_($item->description); ?>"
							...
							<?php  if (JText::_($item->title) == 'Single Article') echo 'Single Article'; ?>
					...
					<?php endforeach; ?>
                        ...
                        <?php } else if ($user->username == 'superadmin') { ?> 
	...
	<li><?php if ($user->username == 'superadmin') { ?><dl class="menu_type">
