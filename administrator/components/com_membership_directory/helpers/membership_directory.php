...
/**
 * Membership_directory helper.
 */
class Membership_directoryHelper
{
	/**
	...
	public static function addSubmenu($vName = '')
	{
		JSubMenuHelper::addEntry(
			JText::_('COM_MEMBERSHIP_DIRECTORY_TITLE_DIRECTORYS'),
			'index.php?option=com_membership_directory&view=directorys',
			$vName == 'directorys'
		);
		JSubMenuHelper::addEntry(
			JText::_('Import'),
			'index.php?option=com_membership_directory&view=import',
			$vName == 'import'
		);
                JSubMenuHelper::addEntry(
			JText::_('Change Password'),
			'index.php?option=com_membership_directory&view=pass_change',
			$vName == 'pass_change'
		);
	...
	public static function getActions()
	{
		...
		$assetName = 'com_membership_directory';
