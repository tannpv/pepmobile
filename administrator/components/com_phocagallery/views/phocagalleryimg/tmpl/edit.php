...
?>			
		<ul class="adminformlist">
			...
			$formArray = array ('title', 'alias', 'catid','filename');
//                        $formArray = array ('title', 'alias', 'catid','filename', 'ordering',
//			'latitude', 'longitude', 'zoom', 'geotitle', 'videocode', 'vmproductid');vucao
