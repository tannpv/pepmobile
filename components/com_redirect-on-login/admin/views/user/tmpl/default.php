				...
				<table class="adminlist rol_table tabletop">
					...
					<tr>
						...
						<td colspan="2">
							...
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_LOGIN')).' '.JText::_('COM_REDIRECTONLOGIN_AS_CONFIGURED_FOR_ALL_USERS').' <a href="index.php?option=com_redirectonlogin&view=configuration#frontend">';
					...
					<tr>
						...
						<td colspan="2">
							<?php echo JText::_('COM_REDIRECTONLOGIN_LOGOUT_D'); ?>.  <?php echo JText::_('COM_REDIRECTONLOGIN_LOGOUT_B'); ?> <a href="index.php?option=com_redirectonlogin&view=configuration#frontend"><?php echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_CONFIGURATION')); ?></a>.						
						</td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;
					...
					<tr>
						...
						<td colspan="2">
							...
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_USERGROUP')).' / '.JText::_('COM_REDIRECTONLOGIN_ACCESSLEVEL').'. ';
							echo JText::_('COM_REDIRECTONLOGIN_IF_SET_TO').' \''.JText::_('COM_REDIRECTONLOGIN_NORMAL').'\', ';						
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_AS_CONFIGURED_IN')).' <a href="index.php?option=com_redirectonlogin&view=configuration#opening_site">';
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_CONFIGURATION'));
							echo '</a>. ';			
							?>
						</td>
					...
					<tr>
						...
						<td colspan="2">
							...
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_USERGROUP')).' / '.JText::_('COM_REDIRECTONLOGIN_ACCESSLEVEL').'. ';
							echo JText::_('COM_REDIRECTONLOGIN_IF_SET_TO').' \''.JText::_('COM_REDIRECTONLOGIN_NORMAL').'\', ';
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_LOGOUT')).' '.JText::_('COM_REDIRECTONLOGIN_AS_CONFIGURED_FOR_ALL_USERS').' <a href="index.php?option=com_redirectonlogin&view=configuration#frontend">';
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_CONFIGURATION'));
							echo '</a>. ';
							echo JText::_('COM_REDIRECTONLOGIN_IF_SET_TO').' \''.JText::_('COM_REDIRECTONLOGIN_NORMAL').'\', ';
				...
				<table class="adminlist rol_table tabletop">
					...
					<tr>
						...
						<td>
							...
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_USERGROUP')).' / '.JText::_('COM_REDIRECTONLOGIN_ACCESSLEVEL').'. ';
							echo JText::_('COM_REDIRECTONLOGIN_IF_SET_TO').' \''.JText::_('COM_REDIRECTONLOGIN_NORMAL').'\', ';
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_LOGIN')).' '.JText::_('COM_REDIRECTONLOGIN_AS_CONFIGURED_FOR_ALL_USERS').' <a href="index.php?option=com_redirectonlogin&view=configuration#backend">';
							echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_CONFIGURATION'));
							echo '</a>. ';
							echo JText::_('COM_REDIRECTONLOGIN_IF_SET_TO').' \''.JText::_('COM_REDIRECTONLOGIN_NORMAL').'\', ';
							echo JText::_('COM_REDIRECTONLOGIN_NORMAL').' Joomla '.$this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_LOGIN'));					
					...
					<tr>
						...
						<td>
							<?php echo JText::_('COM_REDIRECTONLOGIN_LOGOUT_D'); ?>.  <?php echo JText::_('COM_REDIRECTONLOGIN_LOGOUT_B'); ?> <a href="index.php?option=com_redirectonlogin&view=configuration#backend"><?php echo $this->controller->rol_strtolower(JText::_('COM_REDIRECTONLOGIN_CONFIGURATION')); ?></a>.						
						</td>
					</tr>
				</table>			
			</fieldset>		
