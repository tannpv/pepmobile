 ...
 */
class Membership_directoryViewMembersbycategories extends JView
{
	protected $items;
	 ...
	 */
	 public function displaycomp(){
	 $mode = new  Membership_directoryModelMembersbycategories();
	 $arr  = $mode->getcompany();
	
	   $this->assignRef('item1', $arr);
	 }
