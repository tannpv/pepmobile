 ...
 */
class Membership_directoryControllerMemberenviromentalaward extends Membership_directoryController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Memberenviromentalaward', 'Membership_directoryModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_membership_directory&view=memberenviromentalawardform&layout=edit', false));
	}
