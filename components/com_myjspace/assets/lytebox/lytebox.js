...
//
// BS 12/07/2011 Update images (prev_grey.gif, next_grey.gif, close_grey.png) with no specific language, replace "Image " with " ", "Page " with " " and " of " with " / "
// 
//				* v3.25 (07/08/11)
//				* v3.24 (07/06/11)
//				* v3.23 (07/05/11)
...
LyteBox.prototype.updateDetails = function() {
	...
	if (this.isSlideshow && this.slideArray.length > 1) {
		...
		object.style.display = '';
		object.innerHTML = " " + eval(this.activeFrame + 1) + " / " + this.frameArray.length;
		this.doc.getElementById('lbNavDisplay').style.display = '';
	} else {
		this.doc.getElementById('lbNavDisplay').style.display = 'none';
	}
