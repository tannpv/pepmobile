 ...
 */
class PaymentViewPayment1s extends JView {
...
//        $breakfast =$this->getModel('Breakfast');
        $breakfast = JModel::getInstance('Breakfast', 'PaymentModel');

        $this->breakfast = $breakfast->getConfig('month');
        $this->date = $breakfast->getConfig('date');
