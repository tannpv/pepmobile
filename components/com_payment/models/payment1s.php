 ...
 */
class PaymentModelPayment1s extends JModelList {
    ...
    public function storePayment() {
        ...
        $price = $config->get('breakfast_price');
        $num_member = $data['options'];
...
//        $data["category"] = "Breakfast";
    ...
    public function sendPaymentEmail($order_id) {
        $email = JModel::getInstance('email', 'PaymentModel');
        echo $email->printPaymentEmail($order_id);
    }
    ...
    public function payment() {
        ...
        //$site_root = "localhost/pep2"; // Add the URL to your site
