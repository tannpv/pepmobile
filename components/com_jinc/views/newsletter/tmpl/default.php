...
<div class="jinc_caption" style="margin-top: 35px;">
    <?php
    echo 'Secure-Subscribe to our Email Newsletter';
    ?>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" onSubmit="return checkForm(this);" style="margin-top: 75px;">
    <div class="jinc_frm_subscription">
        <table width="90%" border="0">
            ...
            ?>
                   ...
                   <br><br>
                   <input type="submit" value="<?php echo JText::_('COM_JINC_SUBSCRIBE'); ?>">
